...
This manuscript now defines CERA at task, objective, and module-design levels.
The next stage is implementation-level specification and empirical validation of each module under shared deployment constraints.
...
We plan to implement and ablate the CERA modules, build annotated benchmarks for attribution and evidence linkage, and run controlled comparisons against detection- and caption-centric baselines under matched runtime settings.
