...
Table~\ref{tab:main_results_xd} shows a similar throughput-quality trend on XD-Violence. Event-VLM-Core provides the highest practical throughput among explanation-capable models in this setting. Event-VLM-Full recovers additional semantic quality with marginal latency overhead.
