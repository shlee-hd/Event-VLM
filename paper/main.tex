...
Recent VLMs have shifted visual understanding from recognition to explanation. Instruction-tuned multimodal models now provide grounded explanations across open-domain scenes~\cite{llava,llava15,llavanext,blip2,instructblip}. Additional multimodal assistants reinforce this trend~\cite{gpt4v,pali,llama_adapter,llava_med}. In Intelligent Surveillance Systems (ISS), this shift is operationally critical: causal accident explanation enables immediate response prioritization.
