...
Event-VLM-Core provides the highest practical throughput among explanation-capable models, while Event-VLM-Full recovers additional semantic quality with marginal latency overhead.
...
Our risk-sensitive trigger preserves safety recall, adaptive pruning keeps hazard-critical context under aggressive token reduction, and FC-based decoding reduces KV-bandwidth pressure without retraining the backbone.
