...
Prompt over-specificity & High-priority prompts may overfit rare hazard narratives; mitigation: confidence-based interpolation between standard and critical templates. \\
\bottomrule
\end{tabular}
